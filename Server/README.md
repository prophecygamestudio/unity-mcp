...
```bash
# HTTP (default)
uvx --from git+https://github.com/prophecygamestudio/unity-mcp@v8.1.7#subdirectory=Server \
...
```json
{
  "mcpServers": {
    "UnityMCP": {
      ...
      "args": [
        "--from",
        "git+https://github.com/prophecygamestudio/unity-mcp@v8.1.7#subdirectory=Server",
        "mcp-for-unity",
        "--transport",
        "stdio"
      ],
