...
```
https://github.com/prophecygamestudio/unity-mcp.git?path=/MCPForUnity#v8.1.8
```
...
```bash
uvx --from "git+https://github.com/prophecygamestudio/unity-mcp@v8.1.8#subdirectory=Server" mcp-for-unity --transport http --http-url http://localhost:8080
```
